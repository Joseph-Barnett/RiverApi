const address = fetch('https://environment.data.gov.uk/flood-monitoring/id/stations?riverName=Dawlish+Water')
.then((response) => response.json())
.then((data) => {
    return data.items[0];
});

const waterfetch = fetch('https://environment.data.gov.uk/flood-monitoring/id/measures/45171-level-stage-i-15_min-m')
.then((response) => response.json())
.then((data) => {
